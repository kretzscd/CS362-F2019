...
#include "rngs.h"
#include "interface.h"
#define TESTCARD "ambassadorEffect"
...
int main() {
    ...
    {
	printf ("BEGIN TESTING ambassadorEffect() FOR PLAYER %d\n\n", p + 1);
